                  ...
                  .map((row) => {
                      ...
                      <StyledTableRow hover role="checkbox" tabIndex={-1} key={row.code}>
                          ...
                          return (
                              ...
                              {column.id === 'status'? value === true? 'Enable' : 'Disable' : column.id === 'accountType'? value === 'true' ? 'Admin' : 'Staff' : column.id === 'updatedAt' ? moment(value).format('MM/DD/YY hh:mm:ss A') : column.id === 'email' ? (
