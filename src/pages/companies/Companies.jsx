...
const columns = [
  ...
  { id: 'representativeEmail', label: 'Representative Email', minWidth: 170, fontWeight: '600' },
...
const rows = [
  createData(<TableLink text="Construction Company"/>, "John Smith", <TableLink text="555-555-5555"/>,   <TableLink text="johnsmith@tepia.co"/>, "20", "10", "15", "05/09/22 12:00:00AM PT", "Enabled"),
  createData(<TableLink text="Construction Company"/>, "John Smith", <TableLink text="555-555-5555"/>,   <TableLink text="johnsmith@tepia.co"/>, "20", "10", "15", "05/09/22 12:00:00AM PT", "Enabled"),
  createData(<TableLink text="Construction Company"/>, "John Smith", <TableLink text="555-555-5555"/>,   <TableLink text="johnsmith@tepia.co"/>, "20", "10", "15", "05/09/22 12:00:00AM PT", "Enabled"),
  createData(<TableLink text="Construction Company"/>, "John Smith", <TableLink text="555-555-5555"/>,   <TableLink text="johnsmith@tepia.co"/>, "20", "10", "15", "05/09/22 12:00:00AM PT", "status"),
  createData(<TableLink text="Construction Company"/>, "John Smith", <TableLink text="555-555-5555"/>,   <TableLink text="johnsmith@tepia.co"/>, "20", "10", "15", "05/09/22 12:00:00AM PT", "Disabled"),
  createData(<TableLink text="Construction Company"/>, "John Smith", <TableLink text="555-555-5555"/>,   <TableLink text="johnsmith@tepia.co"/>, "20", "10", "15", "05/09/22 12:00:00AM PT", "status"),
  createData(<TableLink text="Construction Company"/>, "John Smith", <TableLink text="555-555-5555"/>,   <TableLink text="johnsmith@tepia.co"/>, "20", "10", "15", "05/09/22 12:00:00AM PT", "Disabled"),
  createData(<TableLink text="Construction Company"/>, "John Smith", <TableLink text="555-555-5555"/>,   <TableLink text="johnsmith@tepia.co"/>, "20", "10", "15", "05/09/22 12:00:00AM PT", "Disabled"),
  createData(<TableLink text="Construction Company"/>, "John Smith", <TableLink text="555-555-5555"/>,   <TableLink text="johnsmith@tepia.co"/>, "20", "10", "15", "05/09/22 12:00:00AM PT", "status"),
...
const Companies = () => {
  const {isDrawerOpen, isAddCompanyModal} = useSelector((store) => store.login)
    ...
    <div className="page-section">
      ...
      <Box sx={{
          ...
          <Box component="div" sx={{
            ...
            <Button variant="outlined" className="bc-btn-outline" color="primary" onClick={() => dispatch(handleAddCompanyModal())}>Add Company</Button>
          </Box>
        </Box>
