                        ...
                        {columns.map((column) => {
                          ...
                          return (
                            ...
                            >
                              ...
                              ): column.id === 'representativeNumber'? (<Typography className='tableLink'>{value}</Typography>) : column.id === 'representativeEmail'? (<Typography className="tableLink">{value}</Typography>) : column.id === 'dateLastActive'? (moment(new Date()).format('MM/DD/YY hh:mm:ss A')) : ( column.format && typeof value === "number"
                              ? column.format(value)
                              : value) }
                            </StyledTableCell>
                          );
